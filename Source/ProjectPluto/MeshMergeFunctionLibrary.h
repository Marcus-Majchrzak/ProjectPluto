...
struct PROJECTPLUTO_API FSkelMeshMergeSectionMapping_BP
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct PROJECTPLUTO_API FSkelMeshMergeUVTransform
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct PROJECTPLUTO_API FSkelMeshMergeUVTransformMapping
{
    GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct PROJECTPLUTO_API FSkeletalMeshMergeParams
{
    GENERATED_BODY()
...
*/
UCLASS()
class PROJECTPLUTO_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /**
